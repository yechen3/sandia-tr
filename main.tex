...
\pagenumbering{arabic}
    ...
    \input{sst-gpgpu_perf_SAND/sst_gpgpu_perf_abstract}
\section{Introduction}
    \input{sst-gpgpu_perf_SAND/sst_gpgpu_perf_intro}
\section{Balar Components}
    \subsection{GPU Scheduler}
        \input{sst-gpgpu_SAND/sst_gpgpu_sched}
    \subsection{SM Blobs}
        \input{sst-gpgpu_SAND/sst_gpgpu_sm}
\section{Evaluation}
    \subsection{Correlation}
        \input{sst-gpgpu_perf_SAND/sst_gpgpu_perf_eval-correlation}
    \subsection{Kokkos}
        \input{sst-gpgpu_perf_SAND/sst_gpgpu_perf_eval-kokkos}
    \subsection{Lulesh}
...
\section{Conclusion}
    \input{sst-gpgpu_perf_SAND/sst_gpgpu_perf_conclusion}
