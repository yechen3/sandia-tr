...
\section{Introduction}
    \input{UVMSmart/sst_gpgpu_perf_intro}
\section{Background}
    \subsection{On-Demand GPU Memory}
	\input{UVMSmart/sst_gpgpu_perf_pt}
    \subsection{GPU Page-Fault Handling}
	\input{UVMSmart/sst_gpgpu_perf_pf}
...
\section{Evaluation}
    ...
    \subsection{Lulesh}
        \input{sst-gpgpu_perf_SAND/sst_gpgpu_perf_eval-lulesh}
