...
\newcommand{\proptitle}{Sandia Technical Report: Unified Memory: GPGPU-Sim/UVMSmart Integration}
\newcommand{\shorttitle}{Unified Memory}
...
\section{Background}
	...
	\input{UVMSmart/uvm_bg_prefetcher}
\section{UVM Smart Integration}
    \subsection{Merge Code}
        \input{UVMSmart/uvm_merge_code}
    \subsection{Optimize Simulation Performance}
        \input{UVMSmart/uvm_sim_perf}
    \subsection{Improve TLB performance}
        \input{UVMSmart/uvm_tlb_perf}
\section{Evaluation}
    \subsection{Correlation}
        \input{UVMSmart/uvm_eval-correlation}
    \subsection{TLB Performance}
        \input{UVMSmart/uvm_eval-tlb}
